...
function ConfirmationContent() {
    ...
    return (
        <div className="max-w-lg mx-auto py-8 space-y-8 text-center animate-in fade-in zoom-in-95 duration-300">
            {/* Success Icon */}
            ...
            <div className="space-y-2">
                ...
                <p className="text-text-secondary">
                    Your PO has been successfully created in Zoho Books
                </p>
            </div>

            {/* PO Number Card */}
            <div className="bg-surface-elevated rounded-[var(--radius-lg)] border border-border p-6 space-y-4">
                <div>
                    ...
                    <div className="flex items-center justify-center gap-3 mt-2">
                        ...
                        <button
                            onClick={handleCopy}
                            className="p-2 rounded-[var(--radius-md)] hover:bg-surface border border-border text-text-secondary hover:text-text-primary transition-smooth"
                ...
                <div className="border-t border-border pt-4 grid grid-cols-2 gap-4 text-left">
                    <div>
                        <p className="text-xs text-text-tertiary uppercase tracking-wider">Vendor</p>
                        <p className="text-sm font-medium text-text-primary mt-1">{vendor}</p>
                    </div>
                    <div>
                        <p className="text-xs text-text-tertiary uppercase tracking-wider">Total Amount</p>
                        <p className="text-sm font-medium text-text-primary mt-1">INR {formattedAmount}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-3">
                ...
                <div className="flex gap-3">
                    <Link href="/zoho-po/new" className="flex-1">
                        <Button variant="outline" className="w-full">
                            Create Another PO
                        </Button>
                    </Link>
                    <Link href="/zoho-po/history" className="flex-1">
